...
class IntegrationDb {
 ...
 function get_results($query){return $this->pdo->query($query)->fetchAll(PDO::FETCH_OBJ);}
...
$schema=[
 ...
 'wp_gep_courses'=>'id BIGINT PRIMARY KEY,title VARCHAR(255)',
 'wp_gep_tests'=>'id BIGINT PRIMARY KEY,title VARCHAR(255),type VARCHAR(20),price DECIMAL(10,2),translated_data TEXT',
